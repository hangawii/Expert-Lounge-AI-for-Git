      ...
      <div ref={detailsRef} className="relative z-20 bg-slate-950 shadow-[0_-50px_100px_rgba(2,6,23,1)]">
        ...
        <footer className="py-8 bg-slate-950 text-center text-slate-600 text-xs border-t border-slate-900">
             <p className="font-serif">
                <a href="https://ynconsultinggroup.com/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold transition-colors">
                    &copy; 2026 Expert Lounge by YN Consulting Group. All rights reserved.
                </a>
             </p>
        </footer>
      </div>

      ...
      try {
        ...
        setTimeout(() => {
          ...
          if (parseResult.data) {
            ...
            // Display internal error from parser if available
            const errorMsg = parseResult.error || "이력서 내용을 분석하지 못했습니다. 수동으로 입력해주세요.";
            setError(errorMsg);
      ...
      */}
      ...
      {isReportMode ? (
        ...
        <div className="flex flex-col h-full bg-slate-950 relative">
          ...
          {/* Error Banner in Input Mode */}
          {error && (
            <div className="mx-8 mt-4 bg-red-900/50 border border-red-500 text-red-200 px-4 py-3 rounded-md flex items-start gap-3 animate-fade-in select-text z-10">
              <svg className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <div>
                <h4 className="font-bold text-sm text-red-100">분석 오류 발생</h4>
